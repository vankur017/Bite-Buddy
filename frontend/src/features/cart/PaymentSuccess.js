...
const PaymentSuccess = () => {
    ...
    const order = location.state?.order || loadOrderHistory().find((entry) => entry.source === "restaurant");
        ...
        <div className="min-h-screen pt-28 pb-20 bg-background dark:bg-dark-950 flex items-center justify-center p-6">
            ...
            >
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <Button variant="secondary" onClick={() => navigate("/store")} size="lg" className="w-full py-5 rounded-2xl">
